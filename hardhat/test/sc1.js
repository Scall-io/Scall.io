...
describe("POP", function () {
  ...
  describe("Initialization", function() {
    ...
    it("Should create the market WBTC/USDC", async function() {
      ...
      marketPool = await MarketPool.deploy(main.target, fakeWBTC, 8, fakeUSDC, 6, fakeBtcOracle.target, 8, BigInt(1000e18), BigInt(20e16));
  ...
  describe("LPs :: Check", function() {
    ...
    it("Should deposit call LP at correct interval for Owner", async function() {
      ...
      tx = await marketPool.deposit(true, BigInt(4e8));
    ...
    it("Should deposit call LP at correct interval for addr2", async function() {
      ...
      tx = await marketPool.connect(addr2).deposit(true, BigInt(3e8));
  ...
  describe("Trades :: Check", function() {
    ...
    it("Should deposit collateral for addr1", async function() {
      ...
      await collateralPool.connect(addr1).depositCollateral(BigInt(1500e6));
    ...
    it("Should open a trade for addr1", async function() {
      ...
      await marketPool.connect(addr1).openContract(true, BigInt(5e8));
  ...
  describe("Trades :: Check", function() {
    ...
    it("Should deposit collateral for addr1", async function() {
      ...
      await collateralPool.connect(addr1).depositCollateral(BigInt(1000e6));
  ...
  describe("Trades :: Check", function() {
    ...
    it("Should open a trade for addr1", async function() {
      ...
      await marketPool.connect(addr1).openContract(true, BigInt(2e8));     
  ...
  describe("Trades :: Check", function() {
    ...
    it("Should deposit collateral for addr1", async function() {
      ...
      await collateralPool.connect(addr1).depositCollateral(BigInt(3000e6));
  ...
  describe("LPs :: Check", function() {
    ...
    it("Should deposit call LP at correct interval for Owner", async function() {
      ...
      let amountValue = BigInt("172500000000");
    ...
    it("Should deposit call LP at correct interval for addr2", async function() {
      ...
      let amountValue = BigInt("57500000000");
  ...
  describe("Trades :: Check", function() {
    ...
    it("Should open a trade for addr1", async function() {
      let strikeValue = BigInt("57500000000000000000000");
      let amountValue = BigInt("115000000000");
  ...
  describe("Trades :: Check", function() {
    ...
    it("Should exercise contract 2", async function() {
      ...
      let balanceBTCAP = await fakeWBTC.balanceOf(addr1.address);
      let balanceUSDCAP = await fakeUSDC.balanceOf(addr1.address);
      console.log("Balance WBTC change: "+(balanceBTCAP - balanceBTCAV)/BigInt(1e8));
  ...
  describe("Trades :: Check jjjjjjjjjjjjjjjjjjjjjj", function() {
    ...
    it("Should give user rewards", async function() {
      console.log("Total Rewards Claimed : "+rewardsClaimed/BigInt(1e16))

      tx = await collateralPool.getRewardsForLp(0, 2);
      console.log("rewards for owner put : "+tx/BigInt(1e16));

      tx = await collateralPool.getRewardsForLp(0, 1);
      console.log("rewards for addr2 call : "+tx/BigInt(1e16));

      tx = await collateralPool.getRewardsForLp(0, 3);
      console.log("rewards for addr2 put : "+tx/BigInt(1e16));
    })

    it("Should give addr1 fees", async function() {
      console.log("Total Fees Claimed : "+feesClaimed/BigInt(1e16))

      tx = await collateralPool.getUserFees(addr1.address);
      console.log("Trader fees USDC : "+tx/BigInt(1e16));
    })
