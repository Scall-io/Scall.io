...
describe("POP", function () {
  ...
  describe("Trade :: Check", function() {
    ...
    it("should give user pending fees", async function() {
      tx = await collateralPool.connect(addr1).getRewardsFromUser(addr1.address);
  ...
  describe("CollateralPool :: Check", function() {
    ...
    it("should give user pending fees", async function() {
      tx = await collateralPool.getRewardsFromUser(addr1.address);
      console.log(tx/BigInt(1e18));
    })
    ...
    it("should give total rent per strike for a specific market", async function() {
      let strikeValue = BigInt("53000000000000000000000"); //ça merde si je met "53000e18"
      tx = await collateralPool.getTotalRentPerStrikeForMarket(strikeValue, 0);
      console.log(tx/BigInt(1e18));
    })
    ...
    it("should give lp share for a specific strike in a specific market", async function() {
      ...
      tx = await collateralPool.getLpsSharePerStrikeForMarket(strikeValue, 0, 0);
      console.log(tx/BigInt(1e18));
