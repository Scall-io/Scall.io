...
contract Main is Ownable {
    ...
    function updateMarket(address _contractAddress, address _priceFeed, uint256 _priceFeedDecimal, uint256 _intervalLength, uint256 _range, uint256 _yield) external onlyOwner() {
